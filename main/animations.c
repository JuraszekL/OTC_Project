...
/* This animation changes opacity of three objects in the startup screen */
void Anm_InitScr2200msOpa(void){
	...
	lv_anim_set_var(&a, ui_StartupScreenPanel);
	lv_anim_set_var(&b, ui_StartupScreenPanel);
	...
	// animate two objects with delay
