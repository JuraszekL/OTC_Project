...
typedef enum {
	...
	UI_EVT_WIFI_POPUP_DELETE_REQUEST,
	UI_EVT_THEME_CHANGE_REQUEST,
	UI_EVT_ALARMSSCR_BACK_BTN_CLICKED,
	UI_EVT_MAINSCR_CLOCK_CLICKED,
	UI_EVT_ALARM_PANEL_CLICKED,
	UI_EVT_ALARM_VALUES_CHANGED,
	UI_EVT_ALARM_RUN,
